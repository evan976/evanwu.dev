...
A couple months ago I was working on a migration — moving an old Cloudflare Pages project to Next.js. AI wrote nearly all the boilerplate: route configs, build scripts, environment variable wiring. Honestly, it saved me two or three days of work.

But none of the hard parts were solved by AI:

- How do you handle middleware that depends on Cloudflare-specific runtime APIs?
- Does the build cache strategy need to change after the migration?
- How do the old Workers routes map to the new App Router?
