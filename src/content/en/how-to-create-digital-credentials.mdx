export const title = 'How to Build Digital Credentials using Solana Attestation Service'
export const description = 'Learn how to build digital credentials using Solana Attestation Service, a new feature in Solana that allows you to create and verify digital credentials.'
