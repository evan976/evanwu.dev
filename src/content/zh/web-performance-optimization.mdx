...
image: '/articles/web-performance-optimization.jpg'
topics: 'Next.js, 性能优化, Web 开发, SEO'
---
...
- [Next.js 延迟加载](https://nextjs.org/docs/app/building-your-application/optimizing/lazy-loading)
- [Web Vitals](https://web.dev/articles/vitals)
- [plaiceholder](https://plaiceholder.co/docs/nextjs)
