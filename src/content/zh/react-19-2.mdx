---
title: 'React 19.2: React 新特性'
description: '探索 React 19.2 的最新特性，包括用于控制应用可见性和性能的全新 Activity 组件，以及用于处理外部系统事件的 useEffectEvent。'
publishedAt: '2025-10-17'
updatedAt: '2026-02-08'
image: '/articles/react-19-2.webp'
topics: 'React, JavaScript, 性能, 开发体验'
---
...
- [React Activity 文档](https://react.dev/reference/react/Activity)
- [React Performance Tracks](https://react.dev/reference/dev-tools/react-performance-tracks)
- [Scheduler track 文档](https://react.dev/reference/dev-tools/react-performance-tracks#scheduler)
- [Components track 文档](https://react.dev/reference/dev-tools/react-performance-tracks#components)
