...
description: 'React Server Components (RSC) 代表了构建 React 应用的范式转变。作为 2020 年 12 月发布的实验性功能，RSC 现已成为 React 生态系统的核心部分，特别是在 Next.js 等利用该技术的框架兴起之后。在这篇博客中，我们将探索一些关于 React Server Components 的最佳技术资源，并附带代码示例帮助你更好地理解这些概念。'
publishedAt: '2025-08-09'
updatedAt: '2026-02-08'
image: '/articles/react-server-component.png'
topics: 'React, Next.js, Server Components, Web 开发'
---

## 什么是 React Server Components？

React Server Components 允许开发者在服务器上渲染组件，减少发送到客户端的 JavaScript 包大小并提升性能。与传统的客户端渲染或服务端渲染不同，RSC 创建了一种新的思维模型，其中一些组件仅在服务器上运行，而其他组件在客户端运行。
...
### 3. Next.js 关于 Server Components 的文档
...
![With React Server Components](/articles/with-react-server-components.avif)
...
由于服务器组件无法访问 React Hooks，需要使用不同的方法来管理状态：
...
React Server Components 代表了构建 React 应用的重大转变。通过采用混合渲染模型，利用服务器和客户端的能力，开发者可以创建更高性能和可扩展的应用。

本博客中提供的资源和代码示例应该有助于你理解 React Server Component 开发中使用的核心概念和模式。随着这项技术的不断成熟，我们可以期待看到更多构建现代 Web 应用的创新方法。
