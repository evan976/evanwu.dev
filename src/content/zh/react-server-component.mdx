...
export const description = 'React Server Components (RSC) 代表了构建 React 应用的范式转变。作为 2020 年 12 月发布的实验性功能，RSC 现已成为 React 生态系统的核心部分，特别是在 Next.js 等利用该技术的框架兴起之后。在这篇博客中，我们将探索一些关于 React Server Components 的最佳技术资源，并附带代码示例帮助你更好地理解这些概念。'
export const publishedAt = '2025-08-09'
export const image = '/react-server-component.png'
