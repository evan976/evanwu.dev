---
title: '用 Solana Attestation Service 打造数字凭证'
description: '手把手带你用 Solana Attestation Service（SAS）创建、签发、验证和撤销链上数字凭证。'
publishedAt: '2025-11-01'
updatedAt: '2026-02-08'
image: '/articles/solana-attestation.webp'
topics: 'Solana, 数字凭证, Web3, TypeScript'
---
...
- [Solana CLI 安装指南](https://solana.com/docs/intro/installation)
- [Solana 程序派生地址 (PDAs)](https://solana.com/docs/core/pda)
- [Solana 账户](https://solana.com/docs/core/accounts)
