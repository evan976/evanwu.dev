---
title: '如何使用 Anchor 构建与 Solana 智能合约交互的 React 前端'
description: '学习如何使用 Anchor（一个用于构建 Solana 智能合约的框架）构建与 Solana 智能合约交互的 React 前端。'
...
- [Solana Web3.js 文档](https://solana.com/docs/clients/javascript)
