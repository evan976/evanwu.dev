export const title = 'Web Performance Optimization in Next.js'
export const description = 'Web performance describes how fast or slow a web app is. It is crucial to application development. A highly optimized web app is quick, appeals to users\' experience, and leads to improved product conversion rates and high search engine ranking.'
export const publishedAt = '2025-10-15'
